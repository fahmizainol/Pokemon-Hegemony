...
#          when :HeatLight then                  newForm = 9
          ...
          when :AcidRain then                   newForm = 10
          when :Sandstorm then                  newForm = 11
  ...
  #        when :Humid then                      newForm = 18
          ...
          when :Hail, :Sleet, :Snow then               newForm = 4
          end
          if @form!=newForm
...
#          when :HeatLight then                  newForm = 9
  ...
  #        when :Humid then                      newForm = 18
          ...
          when :Hail, :Sleet, :Snow then               newType = :ICE
    ...
    # Eiscue - Ice Face
    if isSpecies?(:EISCUE) && self.ability == :ICEFACE && [:Hail,:Sleet,:Snow].include?(@battle.pbWeather)
      if @form == 1
        @battle.pbShowAbilitySplash(self,true)
        pbChangeForm(0,_INTL("{1} transformed!",pbThis))
        @battle.pbHideAbilitySplash(self)
